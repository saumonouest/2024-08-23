...
<form method="post" action="../recipe/find.do">
 <input type=text name=fd size=20 class="input-sm" value="${fd }"> <!-- 컨트롤러에서 이 fd값을 보내줘야 되는 거임-->
 <button class="btn-sm btn-primary">검색</button>
   ...
   <div class="row">
    <div class="text-center">
     <a href="../recipe/find.do?fd=${fd }&page=${curpage>1?curpage-1:curpage}" class="btn btn-sm btn-warning">다음</a>
     ${curpage } page / ${totalpage } pages
     <a href="../recipe/find.do?fd=${fd }&page=${curpage<totalpage?curpage+1:curpage}" class="btn btn-sm btn-warning">이전</a>
    </div>
   </div>
