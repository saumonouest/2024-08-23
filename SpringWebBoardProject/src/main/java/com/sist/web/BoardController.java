...
public class BoardController {
    ...
    *       = void : 파일다운로드 , AJAX나 VueJS => JSON전송 
    ...
    *                => 순서는 상관없다 
    *     메소드명 : 개발자가 원하는...
    *     => 한글 => web.xml 에 등록 => setCharacterEncoding을 사용하지 않는다 
    */
   ...
   // 게시판 입력창을 요청 
   @GetMapping("board/insert.do") // 412 , 매개변수 => 400 
   ...
   @ResponseBody // 자바스크립트나 JSON을 전송시에 사용 => 진화 : @RestController 
   ...
   // 405 – 허용되지 않는 메소드
   // 400 – 잘못된 요청 (Bad Request) => 매개변수 데이터형이 틀리다 
