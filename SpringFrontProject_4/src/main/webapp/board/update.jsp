	  ...
	  <table class="table">
	   ...
	   <tr>
	    <td colspan="2" class="text-center">
	     <input type="button" class="btn btn-sm btn-primary" value="수정하기"
	      @click="boardUpdate()"
	     >
	 ...
	 let insertApp=Vue.createApp({
		 ...
		 methods:{
			 boardUpdate(){
				 ...
				 // Spring에서 데이터를 POST 방식일 경우 => 3번째 매개변수를 데이터로 인식
				 axios.post('http://localhost:8080/web/board/update_vue.do', null, {
					 params:{
						 name:this.name,
